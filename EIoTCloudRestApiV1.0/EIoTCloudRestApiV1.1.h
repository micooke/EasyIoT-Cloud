...
public:
	EIoTCloudRestApi(String _EIoT_Address = "cloud.iot-playground.com", uint16_t _EIoT_Port = 40404, const uint8_t wifi_max_attempts = 5, const uint32_t wifi_interval = 1000) : _EIoT_Address(_EIoT_Address), _EIoT_Port(_EIoT_Port), _wifi_max_attempts(wifi_max_attempts), _wifi_interval(wifi_interval) {}
